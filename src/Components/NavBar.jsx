...
import WhiteLogo from "../statics/white-Logo.png";
  ...
  return (
    <div>
      <nav className={N.navBar}>
        <div
          onClick={HandleNav}
          className={nav ? N.responsiveClosedMenu : N.responsiveMenu}
        >
        ...
        <div className={N.contact}>
          <ReactWhatsapp
            ...
            message={`Hola! Me interesa tener más información sobre los artículos`}
          ...
          <a href="https://www.instagram.com/rocambole.art/" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
